...
NUTRITION_DB = {
    ...
    "butter naan": {"calories": 280, "protein_g": 9, "carbs_g": 48, "fat_g": 10, "quantity": "1 piece"},
    ...
    "pulao": {"calories": 320, "protein_g": 8, "carbs_g": 52, "fat_g": 9, "quantity": "1 bowl"},
    "dhokla": {"calories": 160, "protein_g": 6, "carbs_g": 28, "fat_g": 4, "quantity": "4 pieces"},
    "pakora": {"calories": 240, "protein_g": 6, "carbs_g": 22, "fat_g": 14, "quantity": "4 pieces"},
}
...
LABEL_MAPPINGS = {
    ...
    "fried rice": ("jeera rice", "Jeera Rice"),
    "ramen": ("ramen", "Ramen"),
    "sushi": ("sushi", "Sushi"),
    ...
    "roti": ("naan", "Naan"),
    "garlic bread": ("butter naan", "Butter Naan"),
    "bread": ("butter naan", "Butter Naan"),
    "naan": ("butter naan", "Butter Naan"),
    ...
    "jeera rice": ("jeera rice", "Jeera Rice"),
    "beet salad": ("poha", "Poha"),
    "bread pudding": ("poha", "Poha"),
    "omelette": ("upma", "Upma"),
    "falafel": ("pakora", "Pakora"),
    "onion rings": ("pakora", "Pakora"),
    "cup cakes": ("dhokla", "Dhokla"),
    "cheesecake": ("dhokla", "Dhokla"),
    "french toast": ("dosa", "Dosa"),
    "deviled eggs": ("idli", "Idli"),
    "eggs benedict": ("idli", "Idli"),
    "edamame": ("idli", "Idli"),
    "miso soup": ("dal makhani", "Dal Makhani"),
    "clam chowder": ("dal makhani", "Dal Makhani"),
    "rajma": ("rajma chawal", "Rajma Chawal"),
    "oatmeal": ("upma", "Upma"),
    "frozen yogurt": ("poha", "Poha"),
}
